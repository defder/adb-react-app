...
const SEARCH_URL = "https://rawg.io/api/games?page_size=12&"
...
export const findGamesBySearchTerm = async (term) => {
    const response = await axios.get(`${SEARCH_URL}${API_KEY}&search=${term}`)
    return response.data.results
}